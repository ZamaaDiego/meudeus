...
function area(){
  document.getElementById('fiel').style.display = 'block';
    ...
    if(info=="Cuadrado"){
        ...
        console.log(lado)
        if(Object.is(lado, NaN)==true){
            document.getElementById("resu").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";
        }else{ 
        ...
        document.getElementById("resu").innerHTML = resultadocuadrado+"cm²";}
            ...
            if(Object.is(basee, NaN)==true || Object.is(alturaa, NaN)==true){
                document.getElementById("resu").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";
            }else{
            ...
            if(Object.is(baserec, NaN)==true || Object.is(alturarec, NaN)==true){
                document.getElementById("resu").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";
            }else{
    ...
    if(Object.is(radiocirculo, NaN)==true){document.getElementById("resu").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";}
    else{    var resultadocirculo = (Math.PI*(radiocirculo ** 2)).toFixed(3);
        document.getElementById("kk").innerHTML = "RESULTADO AREA";
...
function peri(){
    ...
    if(info=="Cuadrado"){
        var lado=(parseInt(document.getElementById('lado').value));
        if(Object.is(lado, NaN)==true){
            document.getElementById("resu2").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";
        }else{var perimetro = lado+lado+lado+lado;
            ...
            if(Object.is(base, NaN)==true || Object.is(lado2a, NaN)==true ||Object.is(lado3a, NaN)==true){
                document.getElementById("resu2").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";
            }else{  
     ...
     document.getElementById("resu2").innerHTML = resultadoperi+"cm";}
            ...
            if(Object.is(baserec, NaN)==true || Object.is(alturarec, NaN)==true){
                document.getElementById("resu2").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";
            }else{var perirec = ((2*baserec)+(2*alturarec));
                document.getElementById("kk2").innerHTML = "RESULTADO PERIMETRO";
                document.getElementById("resu2").innerHTML = perirec+"cm";}
            
        }else if(info=="Circulo"){
            var radiocir=(parseInt(document.getElementById('radioin').value));
            if(Object.is(radiocir, NaN)==true){
                document.getElementById("resu2").innerHTML = "ERROR,LLena los espacios para obtener tu resultado";
            }else{            var perimetrocir = (2*Math.PI*radiocir).toFixed(3);
                document.getElementById("kk2").innerHTML = "RESULTADO PERIMETRO";
